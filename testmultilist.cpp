...
int main() {
    Multilist list;
    // list.insert(0, "Andrew", 21);
    // list.insert(1, "Brooklyn", 20);
    // list.insert(2, "Frank", 20);
    // list.insert(3, "Gladdys", 21);
    // list.insert(4, "Kristina", 20);
    // list.insert(5, "Edmund", 19);
    // list.print_by_ID();
    // list.print_by_age();
    // list.remove(3);
    // list.print_by_ID();
    ...
    bool done = false; // toggle to false to run.
    int id, age;
    char command;
    std::string name;
    while (!done) {
